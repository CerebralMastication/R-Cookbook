...
```{r new-rmarkdown-menu, echo=FALSE, eval=TRUE, fig.cap="Create New R Markdown Document"}
knitr::include_graphics("images_v2/new_rmarkdown.png")
```
...
```{r new-rmarkdown-menu2, echo=FALSE, eval=TRUE, fig.cap="New R Markdown Document options"}
knitr::include_graphics("images_v2/new_rmd_diag.png")
```
...
```{r new-rmarkdown-doc, echo=FALSE, eval=TRUE, fig.cap="New R Markdown document"}
knitr::include_graphics("images_v2/new_rmd_text.png")
```
...
```{r headerblock, echo=FALSE, eval=TRUE, fig.cap="Header illustration"}
knitr::include_graphics("images_v2/header_block_rmd.png")
```
...
```
The square root of pi is `r '\x60r sqrt(pi)\x60'`. 
```
...
```{r plot-in-rmd, eval=TRUE, fig.cap="Example ggplot in R Markdown" }
library(ggplot2)
gg <- ggplot(airquality, aes(Wind, Temp)) + geom_point()
print(gg)
```
...
```{r output-small, out.width='30%', fig.cap="Small-width plot"}
print(gg)
```
...
```{r output-big, out.width='100%', fig.cap="Large-width plot "}
print(gg)
```
...
````markdown
`r ''````{r out.width='50%', out.height='20%', fig.cap='Temperature versus wind speed', fig.align='left'}
print(gg)
```
````
...
```{r great-figure, out.width='50%', out.height='20%', fig.cap='Temperature vs. Wind Speed', fig.align='left'}
print(gg)
```
...
```{r kable, fig.cap='A kable table', echo=FALSE, eval=TRUE}
knitr::include_graphics("images_v2/rcbk_16in01.png")
```
...
```{r kabbleextra, fig.cap='A kableExtra table', echo=FALSE, eval=TRUE}
knitr::include_graphics("images_v2/rcbk_16in02.png")
```
...
```{r knithtml, echo=FALSE, eval=TRUE, fig.cap='Knit to HTML'}
knitr::include_graphics("images_v2/knit_to_html.png")
```
...
```{r knitpdf, echo=FALSE, eval=TRUE, fig.cap='Knit to PDF'}
knitr::include_graphics("images_v2/knit_to_pdf.png")
```
...
```{r latextype, echo=FALSE, eval=TRUE, fig.cap='LaTeX typeset'}
knitr::include_graphics("images_v2/write_in_latex.png")
```
...
```{r knitword, echo=FALSE, eval=TRUE, fig.cap="Knit to Word"}
knitr::include_graphics("images_v2/knit_to_word.png")
```
...
```{r wordmatrix, echo=FALSE, eval=TRUE, fig.cap="Matrix in MS Word"}
knitr::include_graphics("images_v2/word_matrix.png")
```
...
```{r wordscaling, echo=FALSE, eval=TRUE, fig.cap="Equation font scaling in MS Word"}
knitr::include_graphics("images_v2/scaling_word.png")
```
...
```{r wordfig, echo=FALSE, eval=TRUE, fig.cap="Graph in Word"}
knitr::include_graphics("images_v2/word_figure.png")
```
...
```{r imagedpi, echo=FALSE, eval=TRUE, fig.cap="Image resolution in Word"}
knitr::include_graphics("images_v2/word_image_dpi.png")
```
...
```{r wordtable, echo=FALSE, eval=TRUE, fig.cap="Table in Word"}
knitr::include_graphics("images_v2/word_table.png")
```
...
```{r wordtable2, echo=FALSE, eval=TRUE, fig.cap="regulartable in Word"}
knitr::include_graphics("images_v2/word_table_flextable1.png")
```
...
```{r flextable2, echo=FALSE, eval=TRUE, fig.cap="A customized regulartable in Word"}
knitr::include_graphics("images_v2/word_table_flextable2.png")
```
...
```{r newprez, echo=FALSE, eval=TRUE, fig.cap="New R Markdown document: Presentations"}
knitr::include_graphics("images_v2/new_presentation.png")
```
...
```{r knitprez, echo=FALSE, eval=TRUE, fig.cap="Knit: Presentations"}
knitr::include_graphics("images_v2/knit_presentation.png")
```
...
```{r paramoutput, echo=FALSE, eval=TRUE, fig.cap="Parameter output"}
knitr::include_graphics("images_v2/params_output.png")
```
...
```{r knitparams, echo=FALSE, eval=TRUE, fig.cap="Knit with Parameters from Knitr menu"}
knitr::include_graphics("images_v2/rstudio_knit_params.png")
```

This then prompts us for parameters, as shown in Figure \@ref(fig:knitparamsdailog).

```{r knitparamsdailog, echo=FALSE, eval=TRUE, fig.cap="Knit with Parameters"}
knitr::include_graphics("images_v2/rstudio_knit_params_dialog.png")
```
